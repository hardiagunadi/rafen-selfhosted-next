...
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Edit Koneksi OLT <span class="mf-dim">HSGQ</span></div>
                <div class="mf-page-sub">{{ $oltConnection->name }} &mdash; {{ $oltConnection->host }}</div>
            </div>
        </div>
        <div class="mf-header-actions">
            <a href="{{ route('olt-connections.show', $oltConnection) }}" class="mf-btn-back">
    ...
    {{-- Footer --}}
    <div class="mf-footer">
        <a href="{{ route('olt-connections.show', $oltConnection) }}" class="mf-btn-cancel">Batal</a>
        <button type="submit" class="mf-btn-submit">
            <i class="fas fa-save mr-1"></i> Update Koneksi OLT
        </button>
    </div>
