...
.mf-row-4 { grid-template-columns:repeat(4,1fr); }
...
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            <div class="mf-page-icon" style="background:linear-gradient(140deg,#7c3aed,#a78bfa);">
                <i class="fas fa-network-wired"></i>
            </div>
            <div>
                <div class="mf-page-title">Tambah Koneksi OLT <span class="mf-dim">HSGQ</span></div>
                <div class="mf-page-sub">Daftarkan perangkat OLT baru untuk monitoring SNMP</div>
            </div>
        </div>
        <div class="mf-header-actions">
            <a href="{{ route('olt-connections.index') }}" class="mf-btn-back">
    ...
    {{-- Footer --}}
    <div class="mf-footer">
        <a href="{{ route('olt-connections.index') }}" class="mf-btn-cancel">Batal</a>
        <button type="submit" class="mf-btn-submit">
            <i class="fas fa-save mr-1"></i> Simpan Koneksi OLT
        </button>
    </div>
