...
@section('title', 'Tambah Profil Group')
...
<form action="{{ route('profile-groups.store') }}" method="POST">
@csrf
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Tambah Profil Group</div>
            </div>
        </div>
                    ...
                    <div class="mf-field">
                        ...
                        <select name="mikrotik_connection_id" class="mf-input @error('mikrotik_connection_id') mf-input-error @enderror">
                            ...
                            @foreach($mikrotikConnections as $conn)
                                <option value="{{ $conn->id }}" @selected(old('mikrotik_connection_id') == $conn->id)>{{ $conn->name }}</option>
                            @endforeach
                        </select>
            ...
            <div class="mf-section-body">
                <div class="mf-row">
                    ...
                    <div class="mf-field">
                        ...
                        <input type="text" name="ip_pool_name" value="{{ old('ip_pool_name') }}" class="mf-input @error('ip_pool_name') mf-input-error @enderror" placeholder="Pool Mikrotik">
                ...
                <div id="sql-pool-fields">
                    <div class="mf-row">
                        <div class="mf-field">
                            ...
                            <input type="text" name="range_start" value="{{ old('range_start') }}" class="mf-input @error('range_start') mf-input-error @enderror" placeholder="10.0.0.2">
                            @error('range_start')<div class="mf-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mf-field">
                            <label class="mf-label">Range IP Akhir</label>
                            <input type="text" name="range_end" value="{{ old('range_end') }}" class="mf-input @error('range_end') mf-input-error @enderror" placeholder="10.0.0.254">
                    ...
                    <div class="mf-row" style="margin-top:.85rem;">
                        <div class="mf-field">
                            ...
                            <input type="text" name="ip_address" value="{{ old('ip_address') }}" class="mf-input @error('ip_address') mf-input-error @enderror" placeholder="10.0.1.0">
                            @error('ip_address')<div class="mf-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mf-field">
                            <label class="mf-label">Netmask (SQL IP Pool)</label>
                            <input type="text" name="netmask" value="{{ old('netmask') }}" class="mf-input @error('netmask') mf-input-error @enderror" placeholder="255.255.255.0 atau 24">
                ...
                <div class="mf-row">
                    <div class="mf-field" id="dns-server-group">
                        ...
                        <input type="text" id="dns_servers" name="dns_servers" value="{{ old('dns_servers', '8.8.8.8,8.8.4.4') }}" class="mf-input @error('dns_servers') mf-input-error @enderror" placeholder="8.8.8.8,8.8.4.4">
