...
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Tambah <span class="mf-dim">User Hotspot</span></div>
                <div class="mf-page-sub">Daftarkan pelanggan hotspot baru</div>
            </div>
        </div>
            ...
            <div class="mf-section-body">
                    ...
                    <div class="mf-field">
                        ...
                        <div style="display:flex;gap:1.2rem;align-items:center;flex-wrap:wrap;padding-top:.35rem;">
                            <label style="display:inline-flex;align-items:center;gap:.4rem;font-size:.85rem;font-weight:600;cursor:pointer;">
                                <input type="radio" name="status_registrasi" value="aktif" @checked(old('status_registrasi', 'aktif') === 'aktif') required> AKTIF
                            </label>
                            <label style="display:inline-flex;align-items:center;gap:.4rem;font-size:.85rem;font-weight:600;cursor:pointer;">
                                <input type="radio" name="status_registrasi" value="on_process" @checked(old('status_registrasi') === 'on_process')> ON PROCESS
                            </label>
                        </div>
                ...
                <div class="mf-row">
                    ...
                    <div class="mf-field">
                        ...
                        <input type="date" name="jatuh_tempo" class="mf-input @error('jatuh_tempo') mf-input-error @enderror" value="{{ old('jatuh_tempo') }}">
            ...
            <div class="mf-section-body">
                <div class="mf-row">
                    <div class="mf-field">
                        ...
                        <input type="text" name="customer_name" class="mf-input @error('customer_name') mf-input-error @enderror" value="{{ old('customer_name') }}" required>
                        @error('customer_name')<div class="mf-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">ID Pelanggan <span style="font-size:.7rem;font-weight:600;border-radius:20px;padding:.1rem .45rem;background:rgba(14,165,233,.15);color:#0369a1;margin-left:.2rem;">Auto</span></label>
                        <div style="display:flex;gap:.4rem;">
                            <input type="text" name="customer_id" id="customer_id" class="mf-input @error('customer_id') mf-input-error @enderror" value="{{ old('customer_id') }}" placeholder="Memuat..." readonly style="flex:1;">
                            <button type="button" id="btn-generate-customer-id" title="Generate ulang ID" style="height:38px;padding:0 .65rem;border-radius:9px;border:1px solid var(--app-border,#d7e1ee);background:#fff;color:#5b6b83;cursor:pointer;font-size:.85rem;flex-shrink:0;">
                                <i class="fas fa-sync-alt"></i>
                            </button>
                            <button type="button" id="btn-unlock-customer-id" title="Edit manual" style="height:38px;padding:0 .65rem;border-radius:9px;border:1px solid var(--app-border,#d7e1ee);background:#fff;color:#5b6b83;cursor:pointer;font-size:.85rem;flex-shrink:0;">
                ...
                <div class="mf-row mf-row-3">
                    <div class="mf-field">
                        ...
                        <input type="text" name="nomor_hp" class="mf-input @error('nomor_hp') mf-input-error @enderror" value="{{ old('nomor_hp') }}" placeholder="08xxx / 62xxx">
                        @error('nomor_hp')<div class="mf-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Email</label>
                        <input type="email" name="email" class="mf-input @error('email') mf-input-error @enderror" value="{{ old('email') }}">
                        @error('email')<div class="mf-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">NIK</label>
                        <input type="text" name="nik" class="mf-input @error('nik') mf-input-error @enderror" value="{{ old('nik') }}">
                ...
                <div class="mf-field">
                    ...
                    <textarea name="alamat" class="mf-input @error('alamat') mf-input-error @enderror" rows="2">{{ old('alamat') }}</textarea>
            ...
            <div class="mf-section-body">
                ...
                <div class="mf-row">
                    <div class="mf-field">
                        ...
                        <input type="text" name="username" class="mf-input @error('username') mf-input-error @enderror" value="{{ old('username') }}" required placeholder="Username">
                    ...
                    <div class="mf-field" id="password-field-row">
                        ...
                        <input type="text" name="hotspot_password" id="hotspot-password-input" class="mf-input @error('hotspot_password') mf-input-error @enderror" value="{{ old('hotspot_password') }}" placeholder="Password">
