...
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Tambah Data <span class="mf-dim">ODP</span></div>
                <div class="mf-page-sub">Daftarkan titik Optical Distribution Point baru</div>
            </div>
        </div>
            ...
            <div class="mf-section-body">
                <div class="mf-row mf-row-3">
                    <div class="mf-field">
                        ...
                        <select name="owner_id" id="odp-owner-id" class="mf-input @error('owner_id') mf-input-error @enderror" required>
                            @foreach($owners as $owner)
                                <option value="{{ $owner->id }}" @selected(old('owner_id', auth()->user()->effectiveOwnerId()) == $owner->id)>{{ $owner->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mf-field">
                        ...
                        <div style="display:flex;gap:0;">
                            <input type="text" name="code" id="odp-code" value="{{ old('code') }}" class="mf-input @error('code') mf-input-error @enderror" style="border-radius:9px 0 0 9px;" required>
                ...
                <div class="mf-row mf-row-3">
                    <div class="mf-field">
                        ...
                        <input type="text" name="area" id="odp-area" value="{{ old('area') }}" class="mf-input @error('area') mf-input-error @enderror">
                        @error('area')<div class="mf-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Kapasitas Port</label>
                        <input type="number" name="capacity_ports" value="{{ old('capacity_ports', 8) }}" min="0" class="mf-input @error('capacity_ports') mf-input-error @enderror">
            ...
            <div class="mf-section-body">
                <div style="display:grid;grid-template-columns:1fr 1fr auto;gap:.85rem;align-items:end;">
                    <div class="mf-field">
                        ...
                        <input type="text" name="latitude" id="odp-latitude" value="{{ old('latitude') }}" class="mf-input @error('latitude') mf-input-error @enderror" placeholder="-7.1234567">
                        @error('latitude')<div class="mf-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Longitude</label>
                        <input type="text" name="longitude" id="odp-longitude" value="{{ old('longitude') }}" class="mf-input @error('longitude') mf-input-error @enderror" placeholder="109.1234567">
                ...
                <div class="mf-field">
                    ...
                    <textarea name="notes" class="mf-input @error('notes') mf-input-error @enderror" rows="3">{{ old('notes') }}</textarea>
