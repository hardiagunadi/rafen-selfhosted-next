...
<div class="mf-page">
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Edit Profil PPP</div>
                <div class="mf-page-sub">Ubah data profil PPP</div>
            </div>
        </div>
                ...
                <div class="mf-section-body">
                    <div class="mf-row">
                        <div class="mf-field">
                            ...
                            <input type="text" name="name" value="{{ old('name', $pppProfile->name) }}" class="mf-input @error('name') mf-input-error @enderror" required>
                    ...
                    <div class="mf-row mf-row-3">
                        <div class="mf-field">
                            ...
                            <input type="number" step="0.01" name="harga_modal" value="{{ old('harga_modal', $pppProfile->harga_modal) }}" class="mf-input @error('harga_modal') mf-input-error @enderror">
                            @error('harga_modal')<div class="mf-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mf-field">
                            <label class="mf-label">Harga Promo</label>
                            <input type="number" step="0.01" name="harga_promo" value="{{ old('harga_promo', $pppProfile->harga_promo) }}" class="mf-input @error('harga_promo') mf-input-error @enderror">
                            @error('harga_promo')<div class="mf-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mf-field">
                            <label class="mf-label">PPN (%)</label>
                            <input type="number" step="0.01" name="ppn" value="{{ old('ppn', $pppProfile->ppn) }}" class="mf-input @error('ppn') mf-input-error @enderror">
                    ...
                    <div class="mf-row">
                        <div class="mf-field">
                            ...
                            <input type="number" name="masa_aktif" value="{{ old('masa_aktif', $pppProfile->masa_aktif) }}" class="mf-input @error('masa_aktif') mf-input-error @enderror" min="1">
