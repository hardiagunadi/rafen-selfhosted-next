...
@section('title', 'Tambah Akun PPPoE / Hotspot')
...
<form action="{{ route('radius-accounts.store') }}" method="POST">
@csrf
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Tambah Akun PPPoE / Hotspot</div>
            </div>
        </div>
            ...
            <div class="mf-section-body">
                <div class="mf-row">
                    <div class="mf-field">
                        ...
                        <input type="text" name="username" value="{{ old('username') }}" class="mf-input @error('username') mf-input-error @enderror" required>
                        @error('username')<div class="mf-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Password <span class="mf-req">*</span></label>
                        <input type="text" name="password" value="{{ old('password') }}" class="mf-input @error('password') mf-input-error @enderror" required>
            ...
            <div class="mf-section-body">
                <div class="mf-row mf-row-3">
                    ...
                    <div class="mf-field">
                        ...
                        <input type="text" name="ipv4_address" value="{{ old('ipv4_address') }}" class="mf-input @error('ipv4_address') mf-input-error @enderror" placeholder="Hanya untuk PPPoE">
                    ...
                    <div class="mf-field">
                        ...
                        <input type="text" name="rate_limit" value="{{ old('rate_limit') }}" class="mf-input @error('rate_limit') mf-input-error @enderror" placeholder="mis. 10M/10M">
                ...
                <div class="mf-row mf-row-3">
                    <div class="mf-field">
                        ...
                        <input type="text" name="profile" value="{{ old('profile') }}" class="mf-input @error('profile') mf-input-error @enderror" placeholder="Hotspot / PPPoE">
                    ...
                    <div class="mf-field">
                        ...
                        <select name="mikrotik_connection_id" class="mf-input @error('mikrotik_connection_id') mf-input-error @enderror">
                            ...
                            @foreach($mikrotikConnections as $connection)
                                <option value="{{ $connection->id }}" @selected(old('mikrotik_connection_id') == $connection->id)>{{ $connection->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mf-field">
                        ...
                        <input type="text" name="notes" value="{{ old('notes') }}" class="mf-input @error('notes') mf-input-error @enderror">
