...
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Tambah Pengguna</div>
            </div>
        </div>
            ...
            <div class="mf-section-body">
                <div class="mf-row">
                    ...
                    <div class="mf-field">
                        ...
                        <input type="text" name="nickname" value="{{ old('nickname') }}" class="mf-input @error('nickname') mf-input-error @enderror" placeholder="Contoh: Teknisi Rafen">
                ...
                <div class="mf-row">
                    <div class="mf-field">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" class="mf-input @error('email') mf-input-error @enderror" required>
                    ...
                    <div class="mf-field">
                        ...
                        <input type="text" name="phone" value="{{ old('phone') }}" class="mf-input @error('phone') mf-input-error @enderror" placeholder="Contoh: 081234567890">
