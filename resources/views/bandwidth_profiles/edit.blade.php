...
@section('title', 'Edit Profil Bandwidth')
...
<div class="mf-page">
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Edit Profil Bandwidth</div>
                <div class="mf-page-sub">Ubah data profil bandwidth</div>
            </div>
        </div>
    ...
    <form action="{{ route('bandwidth-profiles.update', $bandwidthProfile) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="mf-grid">
                ...
                <div class="mf-section-body">
                    <div class="mf-row">
                        <div class="mf-field" style="grid-column:1/-1">
                            ...
                            <input type="text" name="name" value="{{ old('name', $bandwidthProfile->name) }}" class="mf-input @error('name') mf-input-error @enderror" required>
                    ...
                    <div class="mf-row">
                        <div class="mf-field">
                            ...
                            <input type="number" name="upload_min_mbps" value="{{ old('upload_min_mbps', $bandwidthProfile->upload_min_mbps) }}" class="mf-input @error('upload_min_mbps') mf-input-error @enderror" min="0">
                            @error('upload_min_mbps')<div class="mf-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mf-field">
                            <label class="mf-label">Upload Max (Mbps)</label>
                            <input type="number" name="upload_max_mbps" value="{{ old('upload_max_mbps', $bandwidthProfile->upload_max_mbps) }}" class="mf-input @error('upload_max_mbps') mf-input-error @enderror" min="0">
                    ...
                    <div class="mf-row">
                        <div class="mf-field">
                            ...
                            <input type="number" name="download_min_mbps" value="{{ old('download_min_mbps', $bandwidthProfile->download_min_mbps) }}" class="mf-input @error('download_min_mbps') mf-input-error @enderror" min="0">
                            @error('download_min_mbps')<div class="mf-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="mf-field">
                            <label class="mf-label">Download Max (Mbps)</label>
                            <input type="number" name="download_max_mbps" value="{{ old('download_max_mbps', $bandwidthProfile->download_max_mbps) }}" class="mf-input @error('download_max_mbps') mf-input-error @enderror" min="0">
                        ...
                        <div class="mf-field">
                            ...
                            <select name="owner" class="mf-input @error('owner') mf-input-error @enderror">
                                ...
                                @foreach($users as $user)
                                    <option value="{{ $user->name }}" @selected(old('owner', $bandwidthProfile->owner) === $user->name)>{{ $user->name }}</option>
                                @endforeach
                            </select>
        ...
        <div class="mf-footer">
            ...
            <button type="submit" class="mf-btn-submit">
                <i class="fas fa-save" style="margin-right:.4rem"></i> Update
            </button>
        </div>
    </form>
</div>
