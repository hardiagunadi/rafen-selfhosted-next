...
@section('title', 'PPPoE Tidak Aktif')
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
                ...
                <div class="col-md-4 col-sm-6 mb-2">
                    <div class="info-box mb-0">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">PPPoE Tidak Aktif</span>
            ...
            <div class="table-responsive">
                <table id="dt-pppoe-inactive" class="table table-hover table-sm align-middle mb-0 w-100">
    ...
    (function () {
        ...
        function init() {
            ...
            dtTable = $('#dt-pppoe-inactive').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: dtUrl,
                ...
                language: { url: false, emptyTable: 'Tidak ada data PPPoE tidak aktif.', processing: 'Memuat...', search: 'Cari:', lengthMenu: 'Tampilkan _MENU_ baris', info: 'Menampilkan _START_-_END_ dari _TOTAL_', paginate: { next: 'Berikutnya', previous: 'Sebelumnya' } },
                pageLength: 25,
                order: [[5, 'desc']],
            });
