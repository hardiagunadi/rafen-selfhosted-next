...
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Tambah Paket Langganan</div>
                <div class="mf-page-sub">Buat paket langganan baru untuk tenant</div>
            </div>
        </div>
            ...
            <div class="mf-section-body">
                <div class="mf-row" style="grid-template-columns:2fr 1fr;">
                    ...
                    <div class="mf-field">
                        ...
                        <input type="number" name="sort_order" class="mf-input" value="{{ old('sort_order', 0) }}" min="0">
                    </div>
                </div>
                <div class="mf-field">
                    <label class="mf-label">Deskripsi <span class="mf-opt">opsional</span></label>
                    <textarea name="description" class="mf-input" rows="3">{{ old('description') }}</textarea>
                </div>
                <div class="mf-field">
                    <label class="mf-label">Fitur <span class="mf-opt">opsional</span></label>
                    <textarea name="features_text" class="mf-input" rows="4" placeholder="VPN Access&#10;Support 24/7&#10;Backup Harian">{{ old('features_text') }}</textarea>
            ...
            <div class="mf-section-body">
                <div class="mf-row">
                    <div class="mf-field">
                        ...
                        <input type="number" name="price" class="mf-input @error('price') mf-input-error @enderror" value="{{ old('price') }}" min="0" required>
                        @error('price')
                            <span class="mf-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mf-field">
                        ...
                        <input type="number" name="duration_days" class="mf-input @error('duration_days') mf-input-error @enderror" value="{{ old('duration_days', 30) }}" min="1" required>
                        @error('duration_days')
                            <span class="mf-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mf-row mf-row-3">
                    <div class="mf-field">
                        ...
                        <input type="number" name="max_mikrotik" class="mf-input" value="{{ old('max_mikrotik', -1) }}" min="-1" required>
                        <span class="mf-hint">-1 untuk unlimited</span>
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Max PPP Users <span class="mf-req">*</span></label>
                        <input type="number" name="max_ppp_users" class="mf-input" value="{{ old('max_ppp_users', -1) }}" min="-1" required>
                        <span class="mf-hint">-1 untuk unlimited</span>
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Max VPN Peers <span class="mf-req">*</span></label>
                        <input type="number" name="max_vpn_peers" class="mf-input" value="{{ old('max_vpn_peers', -1) }}" min="-1" required>
                        <span class="mf-hint">-1 untuk unlimited</span>
                    </div>
                </div>
            </div>
