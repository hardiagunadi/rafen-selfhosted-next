...
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Edit Paket Langganan</div>
                <div class="mf-page-sub"><span class="mf-dim">{{ $plan->name }}</span></div>
            </div>
        </div>
        <div class="mf-header-actions">
            <a href="{{ route('super-admin.subscription-plans.index') }}" class="mf-btn-back">
    ...
    <div class="mf-grid">
        ...
        <div class="mf-section">
            <div class="mf-section-header">
                ...
                <span class="mf-section-title">Informasi Paket</span>
            </div>
            <div class="mf-section-body">
                <div class="mf-row" style="grid-template-columns:2fr 1fr;">
                    <div class="mf-field">
                        <label class="mf-label">Nama Paket <span class="mf-req">*</span></label>
                        <input type="text" name="name" class="mf-input @error('name') mf-input-error @enderror" value="{{ old('name', $plan->name) }}" required>
                        @error('name')
                            <span class="mf-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Urutan <span class="mf-opt">opsional</span></label>
                        <input type="number" name="sort_order" class="mf-input" value="{{ old('sort_order', $plan->sort_order) }}" min="0">
                    </div>
                </div>
                <div class="mf-field">
                    <label class="mf-label">Deskripsi <span class="mf-opt">opsional</span></label>
                    <textarea name="description" class="mf-input" rows="3">{{ old('description', $plan->description) }}</textarea>
                </div>
                <div class="mf-field">
                    <label class="mf-label">Fitur <span class="mf-opt">opsional</span></label>
                    <textarea name="features_text" class="mf-input" rows="4">{{ old('features_text', is_array($plan->features) ? implode("\n", $plan->features) : '') }}</textarea>
                    <span class="mf-hint">Masukkan satu fitur per baris</span>
                </div>
            </div>
        </div>
        ...
        <div class="mf-section">
            <div class="mf-section-header">
                ...
                <span class="mf-section-title">Harga & Durasi</span>
            </div>
            <div class="mf-section-body">
                <div class="mf-row">
                    <div class="mf-field">
                        <label class="mf-label">Harga (Rp) <span class="mf-req">*</span></label>
                        <input type="number" name="price" class="mf-input @error('price') mf-input-error @enderror" value="{{ old('price', $plan->price) }}" min="0" required>
                        @error('price')
                            <span class="mf-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Durasi (hari) <span class="mf-req">*</span></label>
                        <input type="number" name="duration_days" class="mf-input @error('duration_days') mf-input-error @enderror" value="{{ old('duration_days', $plan->duration_days) }}" min="1" required>
                        @error('duration_days')
                            <span class="mf-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mf-row mf-row-3">
                    <div class="mf-field">
                        <label class="mf-label">Max Mikrotik <span class="mf-req">*</span></label>
                        <input type="number" name="max_mikrotik" class="mf-input" value="{{ old('max_mikrotik', $plan->max_mikrotik) }}" min="-1" required>
                        <span class="mf-hint">-1 untuk unlimited</span>
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Max PPP Users <span class="mf-req">*</span></label>
                        <input type="number" name="max_ppp_users" class="mf-input" value="{{ old('max_ppp_users', $plan->max_ppp_users) }}" min="-1" required>
                        <span class="mf-hint">-1 untuk unlimited</span>
                    </div>
                    <div class="mf-field">
                        <label class="mf-label">Max VPN Peers <span class="mf-req">*</span></label>
                        <input type="number" name="max_vpn_peers" class="mf-input" value="{{ old('max_vpn_peers', $plan->max_vpn_peers) }}" min="-1" required>
                        <span class="mf-hint">-1 untuk unlimited</span>
                    </div>
                </div>
            </div>
        ...
        <div class="mf-section">
            <div class="mf-section-header">
                ...
                <span class="mf-section-title">Pengaturan Tampilan</span>
            </div>
            <div class="mf-section-body">
                <div class="mf-row">
                    <div class="mf-field">
                    ...
                    <div class="mf-field">
                        <label class="mf-switch">
                            ...
                            <span class="mf-switch-track"></span>
                            <span class="mf-switch-label">Featured (Tampil Menonjol)</span>
                        </label>
                    </div>
                </div>
            </div>
    ...
    {{-- Footer --}}
    <div class="mf-footer">
        <a href="{{ route('super-admin.subscription-plans.index') }}" class="mf-btn-cancel">Batal</a>
