...
@section('content')
@php
    $profileType = old('profile_type', 'unlimited');
    $limitType = old('limit_type', 'time');
@endphp
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Tambah <span class="mf-dim">Profil Hotspot</span></div>
                <div class="mf-page-sub">Buat profil hotspot baru</div>
            </div>
        </div>
    ...
    <div class="mf-grid">
        ...
        <div class="mf-section">
            <div class="mf-section-header">
                <div class="mf-section-icon" style="background:linear-gradient(140deg,#0369a1,#0ea5e9);"><i class="fas fa-info-circle"></i></div>
            ...
            <div class="mf-section-body">
                <div class="mf-row mf-row-3">
                    <div class="mf-field">
                        ...
                        <input type="number" step="0.01" name="harga_jual" value="{{ old('harga_jual', 0) }}" class="mf-input @error('harga_jual') mf-input-error @enderror">
        ...
        <div class="mf-section">
            <div class="mf-section-header">
                <div class="mf-section-icon" style="background:linear-gradient(140deg,#0369a1,#0ea5e9);"><i class="fas fa-sliders-h"></i></div>
            ...
            <div class="mf-section-body">
                ...
                <div class="mf-field">
                    ...
                    <div style="display:flex;gap:1.5rem;align-items:center;flex-wrap:wrap;">
                        <label style="display:inline-flex;align-items:center;gap:.4rem;font-size:.85rem;font-weight:600;cursor:pointer;">
                            <input type="radio" name="profile_type" id="profile-type-unlimited" value="unlimited" @checked(old('profile_type', 'unlimited') === 'unlimited')> Unlimited
                        </label>
                        <label style="display:inline-flex;align-items:center;gap:.4rem;font-size:.85rem;font-weight:600;cursor:pointer;">
                            <input type="radio" name="profile_type" id="profile-type-limited" value="limited" @checked(old('profile_type') === 'limited')> Limited
                        </label>
                    </div>
                ...
                <div id="limit-type-section" style="{{ $profileType === 'limited' ? '' : 'display:none;' }}">
                    <div class="mf-field">
                        ...
                        <div style="display:flex;gap:1.5rem;align-items:center;flex-wrap:wrap;">
                            <label style="display:inline-flex;align-items:center;gap:.4rem;font-size:.85rem;font-weight:600;cursor:pointer;">
                                <input type="radio" name="limit_type" id="limit-type-time" value="time" @checked(old('limit_type', 'time') === 'time')> TimeBase
                            </label>
                            <label style="display:inline-flex;align-items:center;gap:.4rem;font-size:.85rem;font-weight:600;cursor:pointer;">
                                <input type="radio" name="limit_type" id="limit-type-quota" value="quota" @checked(old('limit_type') === 'quota')> QuotaBase
                            </label>
                        </div>
                ...
                <div id="time-limit-section" class="mf-row" style="{{ $profileType === 'limited' && $limitType === 'time' ? '' : 'display:none;' }}">
                    <div class="mf-field">
                        ...
                        <input type="number" min="1" name="time_limit_value" value="{{ old('time_limit_value', 60) }}" class="mf-input @error('time_limit_value') mf-input-error @enderror">
                    ...
                    <div class="mf-field">
                        ...
                        <select name="time_limit_unit" class="mf-input @error('time_limit_unit') mf-input-error @enderror">
                            <option value="menit" @selected(old('time_limit_unit', 'menit') === 'menit')>Menit</option>
                            <option value="jam" @selected(old('time_limit_unit') === 'jam')>Jam</option>
                            <option value="hari" @selected(old('time_limit_unit') === 'hari')>Hari</option>
                            <option value="bulan" @selected(old('time_limit_unit') === 'bulan')>Bulan</option>
                        </select>
                ...
                <div id="quota-limit-section" class="mf-row" style="{{ $profileType === 'limited' && $limitType === 'quota' ? '' : 'display:none;' }}">
                    <div class="mf-field">
                        ...
                        <input type="number" min="1" step="0.01" name="quota_limit_value" value="{{ old('quota_limit_value', 1024) }}" class="mf-input @error('quota_limit_value') mf-input-error @enderror">
                    ...
                    <div class="mf-field">
                        ...
                        <select name="quota_limit_unit" class="mf-input @error('quota_limit_unit') mf-input-error @enderror">
                            <option value="mb" @selected(old('quota_limit_unit', 'mb') === 'mb')>MB</option>
                ...
                <div id="masa-aktif-section" class="mf-row" style="{{ $profileType === 'unlimited' ? '' : 'display:none;' }}">
                    <div class="mf-field">
                        ...
                        <input type="number" min="1" name="masa_aktif_value" value="{{ old('masa_aktif_value', 30) }}" class="mf-input @error('masa_aktif_value') mf-input-error @enderror">
                    ...
                    <div class="mf-field">
                        ...
                        <select name="masa_aktif_unit" class="mf-input @error('masa_aktif_unit') mf-input-error @enderror">
                            <option value="menit" @selected(old('masa_aktif_unit', 'hari') === 'menit')>Menit</option>
                            <option value="jam" @selected(old('masa_aktif_unit', 'hari') === 'jam')>Jam</option>
                            <option value="hari" @selected(old('masa_aktif_unit', 'hari') === 'hari')>Hari</option>
                            <option value="bulan" @selected(old('masa_aktif_unit', 'hari') === 'bulan')>Bulan</option>
                        </select>
            ...
            <div class="mf-section-body">
                ...
                <div class="mf-row">
                    <div class="mf-field">
                        ...
                        <input type="number" min="1" name="shared_users" value="{{ old('shared_users', 1) }}" class="mf-input @error('shared_users') mf-input-error @enderror">
                    ...
                    <div class="mf-field">
                        ...
                        <select name="prioritas" class="mf-input @error('prioritas') mf-input-error @enderror">
                            <option value="default" @selected(old('prioritas', 'default') === 'default')>Default</option>
                            @for($i = 1; $i <= 8; $i++)
                                <option value="prioritas{{ $i }}" @selected(old('prioritas') === 'prioritas'.$i)>Prioritas {{ $i }}</option>
                            @endfor
                        </select>
    ...
    <div class="mf-footer">
        ...
        <button type="submit" class="mf-btn-submit"><i class="fas fa-save mr-1"></i> Simpan</button>
    </div>
    </form>
</div>
