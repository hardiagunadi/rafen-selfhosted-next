...
.mf-alert-info { background:#eff6ff;border:1px solid #bfdbfe;color:#1e40af; }
...
<div class="mf-page">
    ...
    <div class="mf-page-header">
        <div class="mf-page-header-left">
            ...
            <div>
                <div class="mf-page-title">Generate Batch Voucher</div>
                <div class="mf-page-sub">Buat voucher hotspot secara massal</div>
            </div>
        </div>
        <div class="mf-header-actions">
            <a href="{{ route('vouchers.index') }}" class="mf-btn-back">
    ...
    <div class="mf-grid">
        ...
        <div class="mf-section">
            <div class="mf-section-header">
                ...
                <span class="mf-section-title">Konfigurasi Voucher</span>
            </div>
            <div class="mf-section-body">
                <div class="mf-row">
                    ...
                    <div class="mf-field">
                        <label class="mf-label">Nama Batch <span class="mf-req">*</span></label>
                        <input type="text" name="batch_name" class="mf-input @error('batch_name') mf-input-error @enderror"
                            value="{{ old('batch_name') }}" placeholder="Contoh: Voucher-2rb-Jan2026" required>
                        <span class="mf-hint">Nama untuk mengelompokkan voucher ini.</span>
                        @error('batch_name')
                            <span class="mf-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                </div>
                <div class="mf-row" style="grid-template-columns:1fr 1fr;">
                    <div class="mf-field">
                        <label class="mf-label">Jumlah Voucher <span class="mf-req">*</span></label>
                        <input type="number" name="jumlah" class="mf-input @error('jumlah') mf-input-error @enderror"
                            value="{{ old('jumlah', 10) }}" min="1" max="1000" required>
                        <span class="mf-hint">Maksimal 1000 per sekali generate.</span>
                        @error('jumlah')
                            <span class="mf-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="mf-alert mf-alert-info">
                    ...
                    <span>Kode voucher akan digenerate otomatis (8 karakter alfanumerik uppercase). Kode yang sama dengan kode yang sudah ada akan dilewati.</span>
                </div>
            </div>
        </div>
    ...
    {{-- Footer --}}
    <div class="mf-footer">
        <a href="{{ route('vouchers.index') }}" class="mf-btn-cancel">Batal</a>
        <button type="submit" class="mf-btn-submit">
            <i class="fas fa-magic" style="margin-right:.45rem;"></i> Generate Voucher
        </button>
    </div>
