    ...
    public function build(): array
    {
        $manifest = [
            ...
            'runtime_files' => [
                ...
                'freeradius-config/dictionary',
                'freeradius-config/radiusd.conf',
                'wa-multi-session/.gitignore',
                'wa-multi-session/LICENSE',
                'wa-multi-session/ecosystem.config.cjs',
                'wa-multi-session/gateway-server.cjs',
                'wa-multi-session/package.json',
                'wa-multi-session/package-lock.json',
                'wa-multi-session/readme.md',
            ],
            'portable_directories' => [
                'freeradius-config/clients.d',
                'freeradius-config/mods-available',
                'freeradius-config/policy.d',
                'freeradius-config/sites-available',
                'wa-multi-session/dist',
            ],
            'views' => [
