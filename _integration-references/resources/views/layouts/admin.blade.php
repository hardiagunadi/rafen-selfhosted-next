        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                    @if(!$authUser->isSuperAdmin() || $impersonatingTenant)
                    @if($subscriptionExpired)
                    ...
                    @endif
                    @if(!auth()->user()->isSuperAdmin() && !auth()->user()->isSubUser())
                    @php
                    ...
                    <li class="nav-item">
                        <a href="{{ route('super-admin.settings.license-public-key') }}" class="nav-link {{ request()->routeIs('super-admin.settings.license-public-key*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-key"></i>
                            <p>Public Key Lisensi</p>
                        </a>
                    </li>
