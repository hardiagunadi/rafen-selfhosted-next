...
$isSelfHostedApp = $selfHostedLicenseEnabled;
...
Route::middleware($superAdminAppMiddleware)->prefix('super-admin')->name('super-admin.')->group(function () use ($isSelfHostedApp, $waFeatureMiddleware): void {
